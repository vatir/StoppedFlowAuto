...
#
# $Id: rpcdump.py 1076 2014-01-09 19:17:14Z bethus@gmail.com $
#
...
class RPCDump:
    KNOWN_PROTOCOLS = {
        ...
        '1655/TCP': (r'ncacn_ip_tcp:%s', 1655)
        }
...
if __name__ == '__main__':
    ...
    dumper = RPCDump( '135/TCP')
    dumper.dump("129.237.98.75")
    #dumper2 = RPCDump('ncacn_ip_tcp:1655')
    #dumper2.dump("129.237.98.75")
